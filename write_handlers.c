 ...
 * @ind: index where the num starts on the buffer
 * @buffer: the buffer
 * @flags: the flags
 * @width: the width
 * @prec: precision of specifier
 * @length: Num length
 * @padd: pading the chars
 * @extra_c: extra char
 *
...
/**
 * write_unsgnd - writing an unsigned num
 * @is_negative: Num indicating if num is neg.
 * @ind: index where the num starts in the buffer.
...
/**
 * write_pointer - writing  memo address
 ...
 * @extra_c: char represents extra chars
 * @padd_start: index where padding should start.
 *
 * Return: how many written chars.
 */
